...
namespace Aproplan.Api.Http
{
    ...
    public class ApiRequestBase : IDisposable
    {
        ...
        public ApiRequestBase(string login, string password, Guid requesterId, string apiVersion = "13", string rootUrl = "https://app.aproplan.com")
        {
            // Force TLS 1.2
        ...
        public ApiRequestBase(string login, string password, Guid requesterId, string rootUrl = null): this(login, password, requesterId, DefaultApiVersion, rootUrl)
        {

        }

        public ApiRequestBase(Guid requesterId, string rootUrl = null) : this(null, null, requesterId, DefaultApiVersion, rootUrl)
        {
